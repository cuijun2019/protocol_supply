...
public class InquiryInfoNotesService {
    ...
    public InquiryInfoNotes findNotesByInquiryId(String inquiryId,String actor){
        return inquiryInfoNotesRepository.findNotesByInquiryId(Constant.DELETE_NO,inquiryId,actor);
